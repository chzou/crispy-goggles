...
training = get_data('snli_data/snli_1.0_train.jsonl')
validation = get_data('snli_data/snli_1.0_dev.jsonl')
test = get_data('snli_data/snli_1.0_test.jsonl')
...
GLOVE_STORE = 'snli_data/precomputed_glove.weights'
if USE_GLOVE:
  if not os.path.exists(GLOVE_STORE + '.npy'):
    print('Computing GloVe')
  
    embeddings_index = {}
    f = open('snli_data/glove.6B.300d.txt')
    for line in f:
      values = line.split(' ')
      word = values[0]
